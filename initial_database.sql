...
--
-- Host: 127.0.0.1
-- Generation Time: May 15, 2019 at 03:53 PM
...
INSERT INTO `category` (`id_category`, `category_name`, `description`, `status`) VALUES
(1, 'Baju Muslim', 'Kategori Baju', '1'),
(2, 'Celana Jeans', 'Celana Gaul', '1');
...
(2, 'Kurdiansyah Lesmana', 'kurdilesmana', '21232f297a57a5a743894a0e4a801fc3', '2', 'default.jpg', '0000-00-00', 0);
...
(3, 1, 'Category', 0, 'category', 'fa fa-navicon', 1),
(4, 1, 'Brands', 0, 'brands', 'fa fa-tags', 1),
(5, 3, 'Menu Management', 0, 'menu', 'fa fa-folder', 1),
(6, 3, 'Submenu Management', 0, 'menu/submenu', 'fa fa-folder-open', 1);
