<script> 
  ...
  $(document).ready(function() {
    tabel = $('#myTable').DataTable({
      ...
      "ajax":
      {
          "url": "<?php echo base_url('customers/view') ?>", // URL file untuk proses select datanya
          "type": "POST"
      },
      "deferRender": true,
      "columns": [
        { "data": "customer_name" }, // Tampilkan nama customer
        { "data": "alamat" },  // Tampilkan alamat
        { "data": "phone" },  // Tampilkan no telepon
    ...
    $('#myTable').on('click', 'tbody .edit_btn', function () {
      ...
      $.redirect('<?php echo base_url().$this->router->class.'/update'; ?>', {'id': data_row['id_customers']}, 'GET');
    });
  });
</script>