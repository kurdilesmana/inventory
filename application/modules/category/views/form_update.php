<div class="row">
  <div class="col-md-12">
    <div class="box box-info">
      ...
      <!-- /.box-header -->
      <!-- form start -->
      <form class="form-horizontal" action="<?php echo base_url().'category/update?id='.$lists['id_category']; ?>" method="post">
        <div class="box-body">
             <?php if(isset($error)) { ?>
          ...
          <div class="form-group" hidden> 
                <label for="id_category" class="col-sm-3 control-label">ID</label>
                <div class="col-sm-6">
                  <input type="text" class="form-control" name="id_category" placeholder="Nama" value="<?php echo isset($lists)?$lists['id_category']:''; ?>">
                </div>
